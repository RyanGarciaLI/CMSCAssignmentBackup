...
model.add(LSTM(units=256, dropout=0.05, recurrent_dropout=0.35, return_sequences=True, input_shape=input_shape))
...
# serialize model to JSON, this is to reflect the model I create
model_json = model.to_json()
